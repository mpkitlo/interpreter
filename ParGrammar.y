...
Block
  : '{' ListStmt '}' { (uncurry AbsGrammar.BNFC'Position (tokenLineCol $1), AbsGrammar.Blk (uncurry AbsGrammar.BNFC'Position (tokenLineCol $1)) (snd $2)) }
...
Stmt
  ...
  | Decl { (fst $1, AbsGrammar.DStmt (fst $1) (snd $1)) }
